...
pub const INITIALIZE_DISCRIMINATOR: u8 = 100;
...
///
                ...
                ///   1. `[writable]` ore_mint
                ///   2. `[writable]` store_mint
                ///   3. `[writable]` metadata
                ///   4. `[writable]` stake
                ///   5. `[writable]` stake_tokens
                ///   6. `[writable]` treasury
                ///   7. `[writable]` vault
                ///   8. `[writable]` vault_tokens
                ///   9. `[optional]` system_program (default to `11111111111111111111111111111111`)
                ///   10. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
          ///   11. `[]` associated_token_program
          ///   12. `[]` metadata_program
          ///   13. `[]` ore_program
                ///   14. `[optional]` rent_sysvar (default to `SysvarRent111111111111111111111111111111111`)
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Initialize {
                              signer: self.signer.expect("signer is not set"),
                                        ...
                                        rent_sysvar: self.rent_sysvar.unwrap_or(solana_pubkey::pubkey!("SysvarRent111111111111111111111111111111111")),
                      };
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn ore_program(&mut self, ore_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn rent_sysvar(&mut self, rent_sysvar: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
